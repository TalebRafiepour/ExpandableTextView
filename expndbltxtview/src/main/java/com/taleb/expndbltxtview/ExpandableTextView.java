package com.taleb.expndbltxtview;
...
public class ExpandableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public ExpandableTextView(final Context context, @Nullable final AttributeSet attrs, final int defStyle) {
        ...
        this.animationDuration = attributes.getInt(R.styleable.ExpandableTextView_animation_duration, 120);
        String fontSrc = attributes.getString(R.styleable.ExpandableTextView_font_asset_src);
        if (fontSrc != null) {
            try {
                this.setTypeface(Typeface.createFromAsset(context.getAssets(), fontSrc));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        this.expandInterpolator = new AnticipateOvershootInterpolator();
